...
var url_base = "/mantenedores/centros_medicos/";
	...
	$("#form-unidad").validationEngine('attach', {
        promptPosition:'topLeft',
		validationEventTrigger:false,
		showOneMessage:true,
        onValidationComplete: function(form, status){
    		if(status) {
    			...
    			var URL = url_base+'processunidad/';
    			...
    			$.ajax({
    				...
    				success: function(json){
    					if(json.result){
    						...
    						setTimeout(function(){
    							window.location.href = url_base+ 'administrar/' + $('#codigo').val()+'/#unid_nombre';
