...
<div class="center">
  <h2>Kinesiologos</h2>
  <a href="/mantenedores/kinesiologos/administrar/"><button class="btn-agregar">Agregar nuevo kinesiologo</button></a>
  <div class="clear"></div>


   
        <form action="#" id="form-filtro" name="form-filtro" class="form-horizontal" method="post">
                                    <div class="filtros1 filtros-kinesiologos"> <span style="margin-right: 20px;">Filtrar por:</span>
                ...
                <div>
                                        <!--<input type="text"   style="width:400px;" class="form-control" id="busqueda" name="kinesiologos" placeholder="Nombre Kinesiologo" value="<?php echo $kinesiologo_f; ?>" />-->
