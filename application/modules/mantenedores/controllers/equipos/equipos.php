...
class Equipos extends CI_Controller {
	...
	function __construct(){
        ...
        //principal
		$this->id_modulo = 15;
        $this->prefijo_pri = "equ_";
        $this->title_gen_plu = "equipos";
        $this->title_gen_sin = "equipo";
        $this->nombre_gen_plu = "equipos";
        $this->nombre_gen_sin = "equipo";
	...
	public function index()	{
		...
		if($this->uri->segment(3)=='busqueda'){
			...
			$data['equipo_f'] = $this->uri->segment(4);
	...
	public function process($codigo = false){
        ...
        if($datos){
            ...
            $tipo_1= $datos[$this->prefijo_pri."tipo_1"];
            ...
            if($codigo){
                ...
                if($this->ws->obtener($this->id_modulo,$this->prefijo_pri."codigo <> $codigo and ".$this->prefijo_pri."nombre = '$nombre'  and ".$this->prefijo_pri."tipo_1 = '$tipo_1'")){
                ...
                #revisa que el nombre ingresado no exista
                if($this->ws->obtener($this->id_modulo,$this->prefijo_pri."nombre = '$nombre' and ".$this->prefijo_pri."tipo_1 = '$tipo_1'")){
                    echo json_encode(array("result"=>false,"msj"=>"El nombre y tipo ingresado ya se encuentra registrado"));
                    exit;
                }
