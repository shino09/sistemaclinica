...
<div class="center">
 ...
 <div class="grupos">
    <div class="info">
        ...
        <input type="hidden" id="codigo_ficha" name="codigo_ficha" value="<?=$this->uri->segment(3)?>" />

    

<div id="con_unidad_2"  name="con_unidad_2">Centro medico: 
         <strong>                                 
                                   <?php $encontrado=0; foreach($datos_info as $dato_info){ ?>

          <?php foreach($rel7 as $re){ ?>
          <?php foreach($rel6 as $re6){ ?>
                      <?php foreach($rel2 as $re2){ ?>

                   <?php if( $dato_info->ficha_clinica == $re->codigo  && $re->unidad_2 == $re6->codigo && $re6->centro_medico == $re2->codigo) {  echo $re2->nombre;$encontrado=1;}?>
            <?php }?>
                        <?php }?>
                           <?php } if($encontrado==1) break;?>
                                                      <?php }?>
...
<div id="con_nombre_completo"  name="con_nombre_completo">Nombre: 
         <strong>                                  <?php foreach($rel7 as $re){ ?>
                   <?php if( $dato_info->ficha_clinica == $re->codigo ) {  echo $re->nombre_completo;}?>
            <?php }?>
...
<div id="con_unidad_2"  name="con_unidad_2">Unidad: 
         <strong>                                  <?php foreach($rel7 as $re){ ?>
          <?php foreach($rel6 as $re6){ ?>
                   <?php if( $dato_info->ficha_clinica == $re->codigo  && $re->unidad_2 == $re6->codigo) {  echo $re6->nombre;}?>
            <?php }?>
                        <?php }?>
...
<div >Rut: 
         <strong>                                      <?php foreach($rel7 as $re){ ?>
                   <?php if( $dato_info->ficha_clinica == $re->codigo ) {  echo $re->rut_;}?>
            <?php }?>
</strong>
</div>    </div>
 ...
 <div class="grupos">
   ...
   <div class="info">
<div id="con_fecha_ingreso"  name="con_fecha_ingreso">Fecha ingreso: 
         <strong>  <?php $encontrado=0; foreach($datos_info as $dato->info){ ?>
        <?php echo $dato_info->fecha_ingreso;$encontrado=1;?>
          <?php if($encontrado==1)break;}  ?>
</strong>
</div>   
</div> 
...
<div class="info">
  <div id="con_dias_evolucion"  name="con_dias_evolucion">Dias de Evolución: 
         <strong> 
        <?php echo $dato_info->dias_conexion;?>
</strong>
</div>   
<div id="con_fecha_ingreso"  name="con_fecha_ingreso">Horas totales  Evolución: 
         <strong>         <?php echo $dato_info->horas_totales_conexion;?>

</strong>
</div>  
<div id="con_fecha_ingreso"  name="con_fecha_ingreso">Dias ventilación Mecanica: 
         <strong>         <?php echo $dato_info->dias_ventilacion_mecanica;?>

</strong>
</div> 
<div id="con_fecha_ingreso"  name="con_fecha_ingreso">Horas totales ventilación Mecanica: 
         <strong>         <?php echo $dato_info->horas_totales_ventilacion_mecanica;?>
 ...
 <span class="clear"></span>
  ...
  <div class="contenedor-tabla" style="overflow-x:auto;"> 
    <a href="/fichas_clinicas/estadia/exportar_estadia/<?=$this->uri->segment(3)?>"><button class="btn-exportar-tabla">Exportar a excel</button></a>
      <table class="table ">
    ...
    <tbody>
     ...
     <!--<tr><td>Saturacion Arterial</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->tipo_de_soporte;?></td><?php } ?><?php } ?></tr>-->
       ...
       <tr><td>Relacion I:E</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->relacion_ie;?></td><?php } ?><?php } ?></tr>
        ...
        <tr><td>pH</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->gases_arteriales_ph_;?></td><?php } ?><?php } ?></tr>
        ...
        <tr><td>Ca</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->electrolito_ca;?></td><?php } ?><?php } ?></tr>
       ...
       <tr><td>Cte. Tpo</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->pulmonar_distensibilidad_cte_tpo;?></td><?php } ?><?php } ?></tr>
        ...
        <tr><td>Respaldo</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->respaldo;?></td><?php } ?><?php } ?></tr>
         <tr><td>Cambio Circuito</td><?php if($datos){?><?php foreach($datos as $dato){?><?php if($dato->cambio_circuito==1){?><td>si</td><?php } ?><?php if($dato->cambio_circuito==0 || $dato->cambio_circuito=='' ){?><td>no</td><?php } ?><?php } ?><?php } ?></tr>
        <tr><td>Aseo Diario</td><?php if($datos){?><?php foreach($datos as $dato){?><?php if($dato->aseo_diario==1){?><td>si</td><?php } ?><?php if($dato->aseo_diario==0 || $dato->aseo_diario==''){?><td>no</td><?php } ?><?php } ?><?php } ?></tr>
        <tr><td>Respaldo</td><?php if($datos){?><?php foreach($datos as $dato){?><td><?php echo $dato->respaldo;?></td><?php } ?><?php } ?></tr>
