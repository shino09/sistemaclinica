...
<div >Rut: 
 ...
 <?php echo $re->rut_;}?>
   ...
   <div>
        <label>Fecha: </label>
        <input type="text" id="datepicker"  class="form-control validate[required]" name="con_fecha_ingreso"  />
        <i class="fa fa-calendar"></i> </div>

      <div>
                  <label >Hora</label>

        <input id="con_hora_ingreso"  class="form-control validate[required]" name="con_hora_ingreso" type="time" placeholder="hora"  />
        <i class="fa fa-calendar"></i> </div>
      </div>
    <div class="cont">
      <div>
        ...
        <select id="con_cupos" class="form-control validate[required]"  name="con_cupos">
          <option value="">Seleccione Cupos</option>
   ...
   <!--<div>
        <label>Tipos de control:</label>
          <select name="con_tipos_de_control"  id="con_tipos_de_control" >
           <?php $salir=0; foreach($pri as $pr) {?>
              <?php foreach($rel7 as $re7){?>
                          <?php if(($pr->ficha_clinica==$this->uri->segment(4)) && $pr->estado_conexion !=1){?>
                              <?php foreach($antes_no_conectado as $des){ ?>

            <option<?php  echo " SELECTED";?> value="<?=$des->codigo?>"><?=$des->nombre?></option>
           <?php } $salir=1;break;?>
          <?php } ?>
                <?php if($salir==0 && ($pr->ficha_clinica==$this->uri->segment(4)) && $pr->estado_conexion==1){?>

                              <?php foreach($antes_conectado as $con){ ?>

            <option<?php  echo " SELECTED";?> value="<?=$con->codigo?>"><?=$con->nombre?></option>
           <?php }$salir=1;break; ?>
          <?php } if($salir==1) break; ?>
          <?php } if($salir==1) break; ?>
...
<!--<div>
        <label>Tipos de control:</label>
          <select name="con_tipos_de_control"  id="con_tipos_de_control" >
            ...
            <option value="">Tipos de control nombre</option>
   ...
   <div>
              <label>Tipo de control:  Habilitar</label>   

    <input type="checkbox" id="con_tipos_de_control2"  name="con_tipos_de_control2" value="1"/>

          <select name="con_tipos_de_control"  id="con_tipos_de_control" >
            <option value="">Tipo Control</option>
          </select>
        </div>
    ...
    <div class="cont">
      <div>
        ...
        <select id="con_tipo_de_soporte" class="form-control validate[required]"  name="con_tipo_de_soporte">
          <option value=""  selected="selected">Seleccione Tipo de Soporte</option>
    ...
    <div>
        <label>Equipos en uso:</label>
         ...
         <!-- <option value="">Seleccione</option>-->
          ...
          <?php endforeach; ?>
          <option value=""  selected="selected">Seleccione Equipo</option>
    ...
    <div class="cont">
      ...
      <div>
        <label>Insumo: </label>
          ...
          <?php } ?>
                    <option value=""  selected="selected">Seleccione Insumo circuito</option>
       ...
       <div>
          ...
          <?php } ?>
          <option value=""  selected="selected">Seleccione Insumo filtro</option>
 ...
 <div>
        <label>Kinesiologo Responsable:</label>
          <select id="con_kinesiologo" class="form-control validate[required]"  name="con_kinesiologo">
            ...
            <option<?php  echo " SELECTED";?> value="<?=$dat->codigo?>"><?=$dat->nombre?></option>
          <?php endforeach; ?>
                    <option value=""  selected="selected">Seleccione Kinesiologo</option>
  ...
  <div>
        ...
        <input id="con_hora_llamado_kinesiologo" name="con_hora_llamado_kinesiologo" type="time" placeholder="hora"  />
        <i class="fa fa-calendar"></i> </div>
     <div>
                  <label >Hora LLegada</label>

        <input id="con_hora_llegada_kinesiologo" name="con_hora_llegada_kinesiologo" type="time" placeholder="hora" />
        <i class="fa fa-calendar"></i> </div>
   
       <div>
                  <label >Hora Salida</label>

        <input id="con_hora_salida_kinesiologo" name="con_hora_salida_kinesiologo" type="time" placeholder="hora"  />
        <i class="fa fa-calendar"></i> </div>
  

      <div>
        <label>Responsable Llamado</label>
        <input type="text" id="con_responsable_llamado"  name="con_responsable_llamado" />
      </div>
...
?>
          <option value=""  selected="selected">Seleccione Volumen</option>
...
?>
          <option value=""  selected="selected">Seleccione Presión</option>
...
?>
          <option value=""  selected="selected">Seleccione Frecuencia cardiaca</option>
...
?>
          <option value=""  selected="selected">Seleccione Frecuencia Respiratoria</option>
    ...
    <div class="cont">
      <div>
       ...
       <div>
          ...
          <option value="">Modo Ventilatorio</option>
            ...
            <option<?php if($dat->tipo == 1) {echo " SELECTED";?> value="<?=$dat->codigo?>"><?=$dat->nombre?><?php }?></option>
          <?php } ?>
                              <option value=""  selected="selected">Seleccione Modo Ventilatorio PC</option>
      ...
      <div>
          ...
          <option value="">Modo Ventilatorio</option>
            ...
            <option<?php if($dat->tipo == 2) {echo " SELECTED";?> value="<?=$dat->codigo?>"><?=$dat->nombre?><?php }?></option>
          <?php } ?>
                                        <option value=""  selected="selected">Seleccione Modo Ventilatorio vC</option>
      ...
      <div>
          ...
          <?php } ?>
                                        <option value=""  selected="selected">Seleccione Modo Ventilatorio Dual</option>
...
?>
          <option value=""  selected="selected">Seleccione PIM/PMAX</option>
...
?>
          <option value=""  selected="selected">Seleccione Presión plateau</option>
...
?>
          <option value=""  selected="selected">Seleccione PEEP</option>
...
?>
          <option value=""  selected="selected">Seleccione Presión media</option>
...
?>
          <option value=""  selected="selected">Seleccione Presión de soporte</option>
...
?>
          <option value=""  selected="selected">Seleccione VC ins</option>
...
?>
          <option value=""  selected="selected">Seleccione VC Esp</option>
...
?>
          <option value=""  selected="selected">Seleccione V min</option>
...
?>
          <option value=""  selected="selected">Seleccione FR VM</option>
...
?>
          <option value=""  selected="selected">Seleccione FR total</option>
...
?>
          <option value=""  selected="selected">Seleccione Tiempo inspiratorio</option>
      ...
      <div class="sub-contenedor">
        <label>Humidificación:</label>
           <select id="con_humidificacion"  name="con_humidificacion">
                      <option value=""  selected="selected">Seleccione Humidificación</option>
...
?>
          <option value=""  selected="selected">Seleccione Temperatura</option>
    ...
    <div class="cont3">
      <div>
        ...
        <select id="con_cambio_matraz_llenado_camara_humidificacion_1"  name="con_cambio_matraz_llenado_camara_humidificacion_1">
                    <option value=""  selected="selected">Seleccione Cambio Matraz/Llenado de cámara humidificadora</option>
 ...
 <select id="con_respaldo"  name="con_respaldo">
          <option value="">Respaldo</option>
            ...
            <option <?php echo " SELECTED";?> value="<?=$dat->codigo?>"><?=$dat->nombre ?></option>
          <?php } ?>
                                                  <option value=""  selected="selected">Seleccione Respaldo</option>
    ...
    <div class="cont3">
      <div class="sub-contenedor">
        ...
        <select id="con_cambio_circuito_1"  name="con_cambio_circuito_1">
                                        <option value=""  selected="selected">Seleccione Cambio de circuito</option>
  ...
  <option value="1">Si</option>
      ...
      <div class="sub-contenedor">
        ...
        <input type="text" id="datepicker_2" name="con_fecha_cambio"  />
        <i class="fa fa-calendar"></i> </div>
      ...
      <div>
        ...
        <select id="con_aseo_diario_2"  name="con_aseo_diario_2">
                                                  <option value=""  selected="selected">Seleccione Aseo diario</option>
