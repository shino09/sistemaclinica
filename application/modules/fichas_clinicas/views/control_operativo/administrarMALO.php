...
<div class="center agregar-control">
  ...
  <div class="grupos">
    <div class="info">
        ...
        <input type="hidden" id="con_ficha_clinica" name="con_ficha_clinica" value="<?=@$dato->ficha_clinica?>" />
...
<div>Centro Medico: 
         <strong>  <?php foreach($rel2 as $dat){ ?>
        <?php if($dato->centro_medico == $dat->codigo) { echo $dat->nombre;}?><input type="hidden" id="con_centro_medico"  name="con_centro_medico" value="<?=@$dat->codigo?>" />
          <?php }  ?>
</strong>
</div>
...
<div >Unidad: <strong>
       <?php if($dato->unidad == 2) { ?> <td><?php  echo 'UCI PEDRIATICA';  ?><input type="hidden" id="con_unidad"  name="con_unidad" value="<?=@$dato->unidad?>" /></td><?php }?>
            <?php if($dato->unidad == 1) { ?> <td><?php  echo 'NEONATOLOGIA UCI/INTERMEDIO';  ?><input type="hidden" id="con_unidad"  name="con_unidad" value="<?=@$dato->unidad?>" /></td><?php }?>
            <?php if($dato->unidad == 0) { ?> <td><?php  echo 'UNIDAD CORONARIA';  ?><input type="hidden" id="con_unidad"  name="con_unidad" value="<?=@$dato->unidad?>" /></td><?php }?>
    </strong></div>
...
<div >Rut: 
         <strong>  <?php foreach($rel as $dat){ ?>
        <?php if($dato->ficha_clinica == $dat->codigo) {?>        <input type="hidden" id="con_rut"  name="con_rut" value="<?=@$dat->rut_?>" />
 <?php echo $dat->rut_;}?>
          <?php }  ?>
</strong>
</div>    </div>
...
<label>
             <input onclick="document.getElementById('field1').disabled=false;document.getElementById('field2').disabled=false;" type="radio" name="example" value="si" id="example_0" />
              Si</label>
  
   <label>
          <input onclick="document.getElementById('field1').disabled=true;document.getElementById('field2').disabled=true;" type="radio" name="example" value="No" id="example_1" />
          No</label>
        </div>
<div>
                <label>Volumen:</label>

        <select id="field1" name="field1" disabled >
...
?>
      ...
      <div>
        ...
        <select id="field2" name="field2" disabled >
...
?>
   ...
   <div>
        <label>Fecha: </label>
        <input type="text" id="datepicker" name="con_fecha_ingreso" value="<?=@$dato->fecha_ingreso?>" />
        <i class="fa fa-calendar"></i> </div>

      <div>
                  <label >Hora</label>

        <input id="con_hora_ingreso" name="con_hora_ingreso" type="time" placeholder="hora" value="<?=@$dato->hora_ingreso?>" />
        <i class="fa fa-calendar"></i> </div>
      </div>
    </div>
sdfds
...
?>
      ...
      <div>
        <label>Tiempo respiratorio:</label>
             <select id="con_tiempo_respiratorio_1"  name="con_tiempo_respiratorio_1">
<?php
    for ($i=0; $i<=4; $i=$i+1)
    {
        ?>
...
?>
      ...
      <div>
        ...
        <input type="text" id="con_flujo_respiratorio"  name="con_flujo_respiratorio"/>
      </div>
      <div>
...
?>
    ...
    <div class="columnas">
      ...
      <div class="col">
        ...
        <div>
          <label>pH:</label>
          <input type="text" id="con_gases_arteriales_ph"  name="con_gases_arteriales_ph"/>
        </div>
        <div>
          <label>Pa02:</label>
 ...
 <select id="con_respaldo"  name="con_respaldo">
    ...
    <div class="cont3">
      <div class="sub-contenedor">
        ...
        <select id="con_cambio_circuito"  name="con_cambio_circuito">
  <option value="1">Si</option>
      ...
      <div class="sub-contenedor">
        ...
        <input type="text" id="datepicker2" name="con_fecha_cambio" value="<?=@$dato->fecha_cambio?>" />
        <i class="fa fa-calendar"></i> </div>
      ...
      <div>
        ...
        <select id="con_aseo_diario_1"  name="con_aseo_diario_1">
  <option value="1">Si</option>
          <option value="2">No</option>        </select>
      </div>
      <div>
 ...
 <select id="con_kinesiologo"  name="con_kinesiologo">
          <option value="">Kinesiologo</option>
            <?php foreach($rel6 as $dat){ ?>
            <option <?php echo " SELECTED";?> value="<?=$dat->codigo?>"><?=$dat->nombre ?></option>
          <?php } ?>
        </select>
