...
class Estadia extends CI_Controller {
	...
	public function index()	{
		...
		if($this->uri->segment(3)=='centro_medico'  && $this->uri->segment(4) !='all'){
			...
			if($this->uri->segment(7)=='nombre' && $this->uri->segment(8) !='all'){
			
			if ($url_busqueda == false){
			$url_busqueda = 'nombre/'.$this->uri->segment(8).'/';
			$data['nombre_completo'] = $this->uri->segment(8);
			//$where .= $this->prefijo_rel7."nombre_completo = '".$this->uri->segment(6)."'";
			$where .= "(".$this->prefijo_rel7."nombre_completo like '".$this->uri->segment(8)."%' or ".$this->prefijo_rel7."nombre_completo like '%".$this->uri->segment(8)."' or ".$this->prefijo_rel7."nombre_completo like '%".$this->uri->segment(8)."%')";
			$config['uri_segment'] = $segment = 15;
			$joinnombre=1;
			...
			$url_busqueda = 'nombre/'.$this->uri->segment(8).'/';
			$data['nombre_completo'] = $this->uri->segment(8);
			//$where .= " and ".$this->prefijo_rel7."nombre_completo = '".$this->uri->segment(6)."'";
			$where .= "and (".$this->prefijo_rel7."nombre_completo like '".$this->uri->segment(8)."%' or ".$this->prefijo_rel7."nombre_completo like '%".$this->uri->segment(8)."' or ".$this->prefijo_rel7."nombre_completo like '%".$this->uri->segment(8)."%')";
			$config['uri_segment'] = $segment = 15;
			$joinnombre=1;
		...
		if($this->uri->segment(9)=='rut' && $this->uri->segment(10) !='all'){
			
			if ($url_busqueda == false){
			$url_busqueda = 'rut/'.$this->uri->segment(10).'/';
			//echo $url_busqueda;die('rut');
			$data['rut_'] = $this->uri->segment(10);
			//$where .=$this->prefijo_pri."rut_ = '".$this->uri->segment(8)."'";
			//$where .= $this->prefijo_rel7."rut_ like '".$this->uri->segment(10)."%'";
			//print_array($data);die('rutttt');
			$where .= $this->prefijo_rel7."rut_ like '".$this->uri->segment(10)."%'  ";
			//echo $where;die('rutttttttttt');
			$config['uri_segment'] = $segment = 15;
						$joinrut=1;
			}
			else{
			...
			//echo $url_busqueda;die('rut');
			$data['rut_'] = $this->uri->segment(10);
			//$where .= " and ".$this->prefijo_pri."rut_ = '".$this->uri->segment(8)."'";
			//$where .= "and ".$this->prefijo_rel7."rut_ like '".$this->uri->segment(10)."%'";
			//print_array($data);die('rutttt');
			$where .= "and ".$this->prefijo_rel7."rut_ like '".$this->uri->segment(10)."%'";
						//echo $where;die('rutttttttttt');
		...
		if($this->uri->segment(11)=='fecha' && $this->uri->segment(14) !='all'){
			
			if ($url_busqueda == false){
			$url_busqueda = 'fecha/'.$this->uri->segment(12).'/';
			$data['fecha'] = $this->uri->segment(12);
...
//echo $where;
	...
	$this->ws->joinInner($this->id_modulo_rel7,"fic_codigo = con_ficha_clinica");##relacion ficha clinica
		...
		//echo $where; die;  
				...
				if($joincentros == 0 && $joinunidad == 0 && $joinnombre == 0 && $joinrut == 0 && $joinfecha == 0 ){
									$data["datos"] = false;
...
//print_array($data);die('');
 ...
 public function exportar_estadia(){
