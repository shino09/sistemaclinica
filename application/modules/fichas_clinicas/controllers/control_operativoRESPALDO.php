	...
	public function process($codigo = false){
		...
		//print_array($datos);die('LLEGO A process');
            ...
            if($codigo){
                ...
                if($this->ws->obtener($this->id_modulo,$this->prefijo_pri."codigo <> $codigo and ".$this->prefijo_pri."rut_ = '$rut_'   and ".$this->prefijo_pri."fecha_ingreso = '$fecha_ingreso'  and ".$this->prefijo_pri."hora_ingreso = '$hora_ingreso' ")){
...
//print_array($datos);die('LLEGO A process');
                ...
                #revisa que el nombre ingresado no exista
                if($this->ws->obtener($this->id_modulo,$this->prefijo_pri."rut_ = '$rut_' and ".$this->prefijo_pri."fecha_ingreso = '$fecha_ingreso'  and ".$this->prefijo_pri."hora_ingreso = '$hora_ingreso'")){
...
$datos2[$this->prefijo_pri."cupos"]=$this->input->post('con_cupos');
		...
		public function process2($codigo = false){
			//$datos['con_modo_ventilatorio_otro']=false;
		$datos = $this->input->post();
		...
		//if(($datos[$this->prefijo_pri."con_soporte_adicional_ecmo_1"])== 'on') $datos[$this->prefijo_pri."con_soporte_adicional_ecmo_1"] =1;
            ...
            //$datos[$this->prefijo_pri."fecha_cambio"]=str_replace("/","-",$fecha_cambio);
                ...
                if( $codigotipo==8 || $codigotipo==9 || $codigotipo==11 || $codigotipo==12 || $codigotipo==14){
             ...
             // print_array($datosconexion);die('actualizar');
              ...
              //print_array($datosdesconexion);die('actualizar');
             ...
             // print_array($datosconexion);die('insetar');
              ...
              $datosdesconexion[$this->prefijo_pri."hora_desconexion"]= $datos[$this->prefijo_pri."hora_ingreso"];
                         //   print_array($datosdesconexion);die('insertar');
